...
public class CopyPasteAssignment {
	...
	@Test
	public void copyPasteValidate() {
		driver = new ChromeDriver();
		driver.manage().window().maximize();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(30));
		driver.get("https://demoqa.com/text-box");
		driver.findElement(By.id("userName")).sendKeys("SeleniumPanda");
		driver.findElement(By.id("userEmail")).sendKeys("seleniumpanda@gmail.com");
		driver.findElement(By.id("currentAddress")).sendKeys("1234 Haviland Ave");
	...
	@Test
	public void copyPasteValidate2() {
		driver = new ChromeDriver();
		driver.manage().window().maximize();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(30));
