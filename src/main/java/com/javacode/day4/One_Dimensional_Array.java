...
public class One_Dimensional_Array {
	...
	public static void main(String[] args) {
		...
		int a1[]; // this is the 2nd most popular way of declaring array
		int []a2;
		int[]a3;
		
		int[] b,c; //b is 1-D and c is 1-D array
		int b1[], c1; //c1; b1 is 1-d and c1 is just a simple int varible
		...
		*/
		...
		//indexing positions foe a will be - 0, 1, 2, 3, 4
